...
export function getYongchuanBoundary() {
    return axios
        .get(
            'https://restapi.amap.com/v3/config/district?key=af0fcd0461c57dea44fb9ac3e4bf6693&keywords=永川&subdistrict=1&extensions=all'
        )
        .then((res) => {
...
//获取 乡镇的 中心
export function getLocationCenter(townName) {
    const townsLocations = GetLocations();
    return townsLocations.find((item) => item.towner === townName).center;
}
