  ...
  props: Object.assign({}, T.props, {
    ...
    rowClassName:{
      ...
      default:(record,index) => {
        return index %2 == 0 ? 'color':'nocolor'
      }
    },
    scroll:{
      type:Object,
  ...
  methods: {
    ...
    loadData (pagination, filters, sorter) {
      ...
      const parameter = Object.assign({
        pageNum:this.showPagination != 'false'? ((pagination && pagination.current) ||
          this.showPagination && this.localPagination.current || this.pageNum) : undefined,
        pageSize: this.showPagination != 'false' ? ((pagination && pagination.pageSize) ||
          this.showPagination && this.localPagination.pageSize || this.pageSize) : undefined
      },
      (sorter && sorter.field && {
      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(r => {
          ...
          this.localPagination = this.showPagination && Object.assign({}, this.localPagination, {
            ...
            total: r.totalRecord, // 返回结果中的总记录数
            showSizeChanger: this.showSizeChanger,
